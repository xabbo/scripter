...
namespace b7.Scripter
{
    public partial class App : Application
    {
        ...
        private void ConfigureServices(HostBuilderContext context, IServiceCollection services)
        {
            ...
            // Interceptor
            string interceptorService = context.Configuration.GetValue("Interceptor:Service", "g-earth").ToLower();
            ...
            foreach (Type type in localAssemblyTypes.Where(
                x => x.Namespace == "b7.Scripter.ViewModel" && x.Name.EndsWith("ViewManager")
            ))
            {
